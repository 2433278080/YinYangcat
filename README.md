...
contract YinYangcat is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 300000000000* 10**6 * 10**9;
    ...
    string private constant _name = "YinYangcat";
    string private constant _symbol = "YYcat";
    uint8 private constant _decimals = 18;
    
    address payable private _developmentAddress = payable(0x84F983DD18611917B3f6ea7916ED84E9A20cD6be);
    address payable private _marketingAddress = payable(0xCBd800F27C20eee9A72Dba2Bacb49B4D520087B9);
